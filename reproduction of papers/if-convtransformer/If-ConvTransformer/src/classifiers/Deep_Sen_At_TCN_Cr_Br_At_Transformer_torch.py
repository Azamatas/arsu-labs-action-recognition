...
def init_weights_orthogonal(m):
    ...
    elif isinstance(m, type(m)) == nn.Linear:
...
#     # save init model
#     output_directory_init = output_directory_models+'init_model.pkl'
# torch.save(network.state_dict(), output_directory_init)   # save only
# the init parameters
...
#     # save last_model
#     output_directory_last = output_directory_models+'last_model.pkl'
# torch.save(network.state_dict(), output_directory_last)   # save only
# the init parameters
